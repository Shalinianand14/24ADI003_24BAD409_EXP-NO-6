...
df = pd.read_csv(r"C:\Users\SHALINI A\Downloads\fraud_smote.csv")
...
print("\n===== FINAL COMPARISON =====")
print(f"Before SMOTE PR AUC : {pr_auc_before:.4f}")
print(f"After SMOTE PR AUC  : {pr_auc_after:.4f}")

if pr_auc_after > pr_auc_before:
    print("SMOTE improved fraud detection performance.")
else:
    print("SMOTE did not significantly improve performance.")
